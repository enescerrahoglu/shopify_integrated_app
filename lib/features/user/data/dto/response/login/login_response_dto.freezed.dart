...
mixin _$LoginResponseDto {
 ...
 String? get data; String? get message; int? get statusCode;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginResponseDto&&(identical(other.data, data) || other.data == data)&&(identical(other.message, message) || other.message == message)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode));
}
...
@override
String toString() {
  return 'LoginResponseDto(data: $data, message: $message, statusCode: $statusCode)';
}
...
@useResult
$Res call({
 String? data, String? message, int? statusCode
});
...
class _LoginResponseDto implements LoginResponseDto {
   _LoginResponseDto({this.data, this.message, this.statusCode});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginResponseDto&&(identical(other.data, data) || other.data == data)&&(identical(other.message, message) || other.message == message)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode));
}
